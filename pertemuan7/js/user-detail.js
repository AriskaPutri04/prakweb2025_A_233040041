            ...
            <div class="detail-header">
                <div class="detail-image-container">
                    <img
                        ...
                        class="detail-image"
                        onerror="this.src='https://ui-avatars.com/api/?name=${user.firstName}+${user.lastName}&size=400&background=3498db&color=fff&font-size=0.4'"
                    >
                </div>
                <div class="detail-info">
                    <h1 class="detail-name">${user.firstName} ${user.lastName}</h1>
