    ...
    <div class="grid gap-4 grid-cols-2">
        ...
        <div class="col-span-2">
            ...
            <input 
                ...
                class="cursor-pointer bg-neutral-secondary border border-heading text-medium rounded-base focus:ring-brand focus:border-brand block w-full shadow-xs placeholder:text-body"
            >
        ...
        <div class="flex items-center space-x-4 border-t border-default pt-4 md:pt-6 mt-4 md:mt-
            ...
            <button type="submit" class="inline-flex items-center text-white bg-brand hover:bg-
                brand-strong box_border border-border-transparent focus:ring-4 focus:ring-brand-medium shadow-
