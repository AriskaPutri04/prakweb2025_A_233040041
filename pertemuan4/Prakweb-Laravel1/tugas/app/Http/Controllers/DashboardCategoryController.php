...
class DashboardPostController extends Controller
{
    ...
    public function update(Request $request, Post $post)
    {
       $rules = [
        ...
        // Validasi slug unik, mengabaikan post yang sedang diedit
        $rules['slug'] = [
            'required', 
        ...
        // 1. Tangani Upload Gambar
        if ($request->file('image')) {
            // Hapus gambar lama (jika ada)
            if ($post->image) {
                // PERBAIKAN: Tentukan disk 'public' saat menghapus
        ...
        return redirect()->route('dashboard.index')->with('success', 'Postingan berhasil diperbarui!');
    }
    ...
    public function destroy(Post $post)
    {
       // 1. Hapus gambar terkait dari storage
        ...
        return redirect()->route('dashboard.index')->with('success', 'Postingan berhasil dihapus!');
    }
}
